...
function ProjectWorkingBrainContent() {
  ...
  const translations = {
    pt: {
      ...
      process: [
        ...
        { emoji: "💡", title: "Insights", description: "Extrair conclusões valiosas para orientar o desenvolvimento de soluções tecnológicas" }
      ],
      results: {
        metrics: [
