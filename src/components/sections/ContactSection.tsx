            ...
            >
                ...
                >
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            className={`border ${errors.fullName ? "border-red-500" : "border-gray-300 dark:border-gray-600"
                    ...
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            maxLength={15}
                            className={`border ${errors.phoneNumber ? "border-red-500" : "border-gray-300 dark:border-gray-600"
                                } bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-300 rounded-lg px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent`}
                ...
                >
                    ...
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`border ${errors.subject ? "border-red-500" : "border-gray-300 dark:border-gray-600"
                                } bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-300 rounded-lg px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent`}
                ...
                >
                    ...
                    <textarea
                        ...
                        onChange={handleChange}
                        className={`border ${errors.message ? "border-red-500" : "border-gray-300 dark:border-gray-600"
