...
const Formacao: React.FC = () => {
    ...
    const translations: Translations = {
        pt: {
            ...
            tecnologias: [
                { nome: "HTML 5", ano: "", icone: <FaHtml5 className="text-gray-900 dark:text-gray-100" /> },
                { nome: "REACT", ano: "", icone: <FaReact className="text-gray-900 dark:text-gray-100" /> },
                { nome: "CSS 3", ano: "", icone: <FaCss3Alt className="text-gray-900 dark:text-gray-100" /> },
                { nome: "REACT NATIVE", ano: "", icone: <FaReact className="text-gray-900 dark:text-gray-100" /> },
                { nome: "SASS", ano: "", icone: <FaSass className="text-gray-900 dark:text-gray-100" /> },
                { nome: "EXPO", ano: "", icone: <SiExpo className="text-gray-900 dark:text-gray-100" /> },
                { nome: "JAVASCRIPT", ano: "", icone: <FaJs className="text-gray-900 dark:text-gray-100" /> },
                { nome: "TAILWIND CSS", ano: "", icone: <SiTailwindcss className="text-gray-900 dark:text-gray-100" /> },
                { nome: "TYPESCRIPT", ano: "", icone: <SiTypescript className="text-gray-900 dark:text-gray-100" /> },
                { nome: "BOOTSTRAP", ano: "", icone: <FaBootstrap className="text-gray-900 dark:text-gray-100" /> },
                { nome: "FIGMA", ano: "", icone: <SiFigma className="text-gray-900 dark:text-gray-100" /> },
                { nome: "PHOTOSHOP", ano: "", icone: <SiAdobephotoshop className="text-gray-900 dark:text-gray-100" /> }
            ],
            certificacoes: [
