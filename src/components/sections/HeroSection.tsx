...
const HeroSection: React.FC = () => {
    ...
    return (
        <section className="flex flex-col items-center justify-between min-h-[93.5vh] text-center px-4 relative bg-purple-50 dark:bg-gray-900 transition-colors duration-300" id="hero-section">
