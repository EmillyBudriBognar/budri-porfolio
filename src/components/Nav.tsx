...
const Nav: React.FC<NavProps> = () => {
    ...
    // Rename to avoid collision with window.scrollTo
    const scrollToSectionFn = useScrollTo();
    ...
    const Links = [
        { name: translations[currentLang]?.home || translations['pt'].home, link: "hero-section" },
        { name: translations[currentLang]?.services || translations['pt'].services, link: "services-section" },
        { name: translations[currentLang]?.projects || translations['pt'].projects, link: "projects-section" },
        { name: translations[currentLang]?.about || translations['pt'].about, link: "aboutme-section" },
        { name: translations[currentLang]?.formation || translations['pt'].formation, link: "formation-section" },
        { name: translations[currentLang]?.contact || translations['pt'].contact, link: "contact-section" },
    ];
    ...
    return (
        <>
            ...
            <motion.nav
                ...
                className={`fixed top-0 left-0 w-full z-50 ${!isHeroSection ? "shadow-lg" : ""
                    }`}
            >
                        ...
                        {open && (
                            ...
                            >
                                ...
                                <div className="flex flex-row items-center gap-4 pt-4 pb-4">
                                    <ThemeToggle language={currentLang} />
                                    <LanguageSelector language={currentLang} onLanguageChange={setLanguage} />
                                </div>
                            </motion.ul>
                        )}
                    </AnimatePresence>
