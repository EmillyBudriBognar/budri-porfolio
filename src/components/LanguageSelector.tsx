...
const LanguageSelector: React.FC<LanguageSelectorProps> = ({ onLanguageChange, language = "pt" }) => {
    ...
    const { tooltip, languages } = translations[language] || translations['pt'];
                    ...
                    >
                        {languages.map((lang) => (
                            <li
                                ...
                                className={`px-4 py-2 text-sm cursor-pointer hover:bg-purple-100 dark:hover:bg-gray-700 ${language === lang.code
