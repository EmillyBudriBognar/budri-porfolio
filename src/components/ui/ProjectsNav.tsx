...
const ProjectsNav: React.FC<ProjectsNavProps> = ({ onBackToMain }) => {
    ...
    return (
        <nav
            className={`w-full fixed top-0 left-0 z-50 transition-all duration-300 ${isScrolled ? "shadow-lg bg-gray-50/90 dark:bg-gray-900/90 backdrop-blur-sm" : "bg-gray-50 dark:bg-gray-900"
                }`}
        >
