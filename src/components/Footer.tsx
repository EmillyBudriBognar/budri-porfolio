...
const Footer: React.FC<FooterProps> = ({ className }) => {
    ...
    // Hook para rolar suavemente até a seção
    ...
    return (
        <footer
            ref={footerRef}
            className={`bg-purple-200 dark:bg-purple-900 text-gray-900 dark:text-white ${className || ""}`}
        >
